...
Following, we present an example of such an interface for the Pharo language. The \ct{objectSpace} object contains the \VM setup interface. \gp{how should I write such an interface in a smalltalkish way?}

...
Application runtime tailoring is the specialization of an application runtime in order that it contains only its required elements at runtime and no more. In other words, tailoring is a technique that generates a specialized application runtime so it can better adapt to devices with constrained resources.

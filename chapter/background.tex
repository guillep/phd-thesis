...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=.4\linewidth]{tower_of_interpreters}
\caption{\textbf{Roles of a reflective language kernel bootstrap.}\label{fig:tower_of_interpreters}

...
The first step of the process is to create the \ct{nil}, \ct{true} and \ct{false} objects needed for execution~(cf. Figure \ref{fig:nil_creation}). It is important to create the \ct{nil} object first in Pharo, as the rest of the objects we create will have their fields initialized to it. \ct{true} and \ct{false} are required for code execution.

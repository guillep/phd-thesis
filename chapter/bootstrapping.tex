...
As we stated in \chapref{background}, this has many negative consequences. First, the \VM~(the Ruby \VM in this case) fixes this basic class hierarchy and prevents us to change it without changing the \VM.
...
\begin{definition}[Object-Oriented language runtime Bootstrap]
...
\section{Bootstrapping without \Vtt}
